...
public final class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<FireboxBlockEntity>> FIREBOX = BLOCK_ENTITIES.register("heater_firebox", () -> BlockEntityType.Builder.of(FireboxBlockEntity::new, ModBlocks.FIREBOX.get()).build(null));
    public static final Supplier<BlockEntityType<HeatingOvenBlockEntity>> HEATING_OVEN = BLOCK_ENTITIES.register("heater_oven", () -> BlockEntityType.Builder.of(HeatingOvenBlockEntity::new, ModBlocks.HEATING_OVEN.get()).build(null));
    public static final Supplier<BlockEntityType<CrucibleBlockEntity>> CRUCIBLE = BLOCK_ENTITIES.register("machine_crucible", () -> BlockEntityType.Builder.of(CrucibleBlockEntity::new, ModBlocks.CRUCIBLE.get()).build(null));
    public static final Supplier<BlockEntityType<FoundryCastingBlockEntity>> FOUNDRY_CASTING = BLOCK_ENTITIES.register("foundry_casting", () -> BlockEntityType.Builder.of(FoundryCastingBlockEntity::new, ModBlocks.FOUNDRY_MOLD.get(), ModBlocks.FOUNDRY_BASIN.get()).build(null));
    public static final Supplier<BlockEntityType<FoundryChannelBlockEntity>> FOUNDRY_CHANNEL = BLOCK_ENTITIES.register("foundry_channel", () -> BlockEntityType.Builder.of(FoundryChannelBlockEntity::new, ModBlocks.FOUNDRY_CHANNEL.get()).build(null));
    public static final Supplier<BlockEntityType<FoundryOutletBlockEntity>> FOUNDRY_OUTLET = BLOCK_ENTITIES.register("foundry_outlet", () -> BlockEntityType.Builder.of(FoundryOutletBlockEntity::new, ModBlocks.FOUNDRY_OUTLET.get(), ModBlocks.FOUNDRY_SLAGTAP.get()).build(null));
    public static final Supplier<BlockEntityType<FoundryTankBlockEntity>> FOUNDRY_TANK = BLOCK_ENTITIES.register("foundry_tank", () -> BlockEntityType.Builder.of(FoundryTankBlockEntity::new, ModBlocks.FOUNDRY_TANK.get()).build(null));
    ...
    public static final Supplier<BlockEntityType<StorageCrateBlockEntity>> STORAGE_CRATE = BLOCK_ENTITIES.register("storage_crate", () -> BlockEntityType.Builder.of(StorageCrateBlockEntity::new, ModBlocks.CRATE_IRON.get(), ModBlocks.CRATE_STEEL.get()).build(null));
    public static final Supplier<BlockEntityType<FatManBlockEntity>> NUKE_MAN = BLOCK_ENTITIES.register("nuke_man", () -> BlockEntityType.Builder.of(FatManBlockEntity::new, ModBlocks.NUKE_MAN.get()).build(null));
