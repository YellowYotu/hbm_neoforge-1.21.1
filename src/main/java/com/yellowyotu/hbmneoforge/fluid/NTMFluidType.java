...
public enum NTMFluidType {
    ...
    public boolean isFlammable() {
        return switch (this) {
            case OIL, OIL_DS, CRACKOIL, CRACKOIL_DS, OIL_COKER, GAS, GAS_COKER, HEAVYOIL, SMEAR, RECLAIMED,
                 PETROIL, PETROIL_LEADED, HEATINGOIL, NAPHTHA, NAPHTHA_DS, NAPHTHA_CRACK, NAPHTHA_COKER,
                 GASOLINE, GASOLINE_LEADED, DIESEL, DIESEL_CRACK, LIGHTOIL, LIGHTOIL_DS, LIGHTOIL_CRACK,
                 KEROSENE, PETROLEUM, AROMATICS, UNSATURATEDS, LPG, NITAN, BALEFIRE, HEAVYOIL_VACUUM,
                 REFORMATE, LIGHTOIL_VACUUM, SOURGAS, XYLENE, HEATINGOIL_VACUUM, DIESEL_REFORM,
                 DIESEL_CRACK_REFORM, KEROSENE_REFORM, REFORMGAS, COALOIL, COALGAS, COALGAS_LEADED,
                 ETHANOL, BIOGAS, BIOFUEL, WOODOIL, COALCREOSOTE, FISHOIL, SUNFLOWEROIL, SOLVENT,
                 RADIOSOLVENT, SYNGAS, OXYHYDROGEN, HYDROGEN, DEUTERIUM, TRITIUM, HYDRAZINE, REDMUD,
                 FLUE_GAS -> true;
            default -> false;
        };
    }
