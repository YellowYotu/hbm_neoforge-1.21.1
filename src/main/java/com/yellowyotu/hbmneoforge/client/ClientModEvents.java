...
import com.yellowyotu.hbmneoforge.client.renderer.ChemicalPlantBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.CrucibleBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.FoundryCastingBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.FoundryChannelBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.FoundryTankBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.FoundryOutletBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.MachinePressBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.AirIntakeBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.MixerBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.SolderingStationBlockEntityRenderer;
import com.yellowyotu.hbmneoforge.client.renderer.OilDerrickBlockEntityRenderer;
...
import com.yellowyotu.hbmneoforge.client.screen.HeaterScreen;
import com.yellowyotu.hbmneoforge.client.screen.CrucibleScreen;
import com.yellowyotu.hbmneoforge.client.screen.FluidStorageScreen;
import com.yellowyotu.hbmneoforge.client.screen.FatManScreen;
...
public final class ClientModEvents {
    ...
    public static void registerMenuScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModMenus.STORAGE_CRATE.get(), StorageCrateScreen::new);
    }
    ...
    public static void registerBlockEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(ModBlockEntities.CRUCIBLE.get(), CrucibleBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.FOUNDRY_CASTING.get(), FoundryCastingBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.FOUNDRY_CHANNEL.get(), FoundryChannelBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.FOUNDRY_TANK.get(), FoundryTankBlockEntityRenderer::new);
        event.registerBlockEntityRenderer(ModBlockEntities.FOUNDRY_OUTLET.get(), FoundryOutletBlockEntityRenderer::new);
    }
