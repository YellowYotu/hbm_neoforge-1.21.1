...
public final class RadiationShieldingBlockItem extends BlockItem {
    ...
    @Override public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) { tooltip.add(Component.translatable("trait.radResistance", trim(resistance)).withStyle(ChatFormatting.YELLOW)); }
