...
public final class ModBlocks {
    ...
    public static final DeferredBlock<ObsidianGravelBlock> GRAVEL_OBSIDIAN = BLOCKS.register("gravel_obsidian", () -> new ObsidianGravelBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(5.0F, 240.0F).sound(SoundType.GRAVEL).requiresCorrectToolForDrops()));
    ...
    public static final DeferredBlock<Block> DEPTH_BRICK = BLOCKS.register("depth_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(5.0F, 10.0F).sound(SoundType.STONE)));
    public static final DeferredBlock<Block> DEPTH_TILES = BLOCKS.register("depth_tiles", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(5.0F, 10.0F).sound(SoundType.STONE)));
    public static final DeferredBlock<Block> DEPTH_NETHER_BRICK = BLOCKS.register("depth_nether_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).strength(5.0F, 10.0F).sound(SoundType.NETHER_BRICKS)));
    public static final DeferredBlock<Block> DEPTH_NETHER_TILES = BLOCKS.register("depth_nether_tiles", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).strength(5.0F, 10.0F).sound(SoundType.NETHER_BRICKS)));
    ...
    private static BlockBehaviour.Properties metalProperties(String name, MapColor color) {
        float resistance = switch (name) {
            case "block_red_copper" -> 25.0F;
            case "block_lead", "block_cobalt" -> 50.0F;
            default -> 10.0F;
        };
    ...
    private static DeferredBlock<FluidStorageBlock> fluidStorage(String name, int capacity, float hardness, float resistance, FluidStorageBlock.StorageKind kind) {
        return BLOCKS.register(name, () -> {
            ...
            if (kind == FluidStorageBlock.StorageKind.TANK) { return new FluidTankMultiblockBlock(properties, capacity, kind, 6, 3, 3); }
